geoCityCountyPos = {
    ...
    香港: [114.2578, 22.3242],
    澳门: [113.5547, 22.1484],
    酉阳土家族苗族自治: [108.8196, 28.8666],
    奉节: [109.3909, 30.9265],
    巫溪: [109.3359, 31.4813],
    开: [108.4131, 31.2561],
    彭水苗族土家族自治: [108.2043, 29.3994],
    云阳: [108.8306, 31.0089],
    万州: [108.3911, 30.6958],
    城口: [108.7756, 31.9098],
    江津: [106.2158, 28.9874],
    石柱土家族自治: [108.2813, 30.1025],
    巫山: [109.8853, 31.1188],
    涪陵: [107.3364, 29.6796],
    丰都: [107.8418, 29.9048],
    武隆: [107.655, 29.35],
    南川: [107.1716, 29.1302],
    秀山土家族苗族自治: [109.0173, 28.5205],
    黔江: [108.7207, 29.4708],
    合川: [106.3257, 30.108],
    綦江: [106.6553, 28.8171],
    忠: [107.8967, 30.3223],
    ...
    毕节地: [105.1611, 27.0648],
    黔南布依族苗族自治州: [107.2485, 25.8398],
    铜仁地: [108.6218, 28.0096],
    ...
    儋州: [109.3291, 19.5653],
    文昌: [110.8905, 19.7823],
    乐东黎族自治: [109.0283, 18.6301],
    三亚: [109.3716, 18.3698],
    琼中黎族苗族自治: [109.8413, 19.0736],
    东方: [108.8498, 19.0414],
    海口: [110.3893, 19.8516],
    万宁: [110.3137, 18.8388],
    澄迈: [109.9937, 19.7314],
    白沙黎族自治: [109.3703, 19.211],
    琼海: [110.4208, 19.224],
    昌江黎族自治: [109.0407, 19.2137],
    临高: [109.6957, 19.8063],
    陵水黎族自治: [109.9924, 18.5415],
    屯昌: [110.0377, 19.362],
    定安: [110.3384, 19.4698],
    保亭黎族苗族自治: [109.6284, 18.6108],
    五指山: [109.5282, 18.8299],
    黑河: [127.1448, 49.2957],
    大兴安岭地: [124.1016, 52.2345],
    哈尔滨: [127.9688, 45.368],
    ...
    海东地: [102.3706, 36.2988],
    西宁: [101.4038, 36.8207],
    崇明: [121.5637, 31.5383],
    南汇: [121.8755, 30.954],
    奉贤: [121.5747, 30.8475],
    浦东新: [121.6928, 31.2561],
    金山: [121.2657, 30.8112],
    青浦: [121.1751, 31.1909],
    松江: [121.1984, 31.0268],
    嘉定: [121.2437, 31.3625],
    ...
    和田地: [81.167, 36.9855],
    哈密地: [93.7793, 42.9236],
    阿克苏地: [82.9797, 41.0229],
    阿勒泰地: [88.2971, 47.0929],
    喀什地: [77.168, 37.8534],
    塔城地: [86.6272, 45.8514],
    昌吉回族自治州: [89.6814, 44.4507],
    克孜勒苏柯尔克孜自治州: [74.6301, 39.5233],
    吐鲁番地: [89.6375, 42.4127],
